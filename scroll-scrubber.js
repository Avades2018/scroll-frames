...
class ScrollScrubber extends HTMLElement {
  connectedCallback() {
    ...
    function frameForScroll() {
      ...
      let p;
      if (trigger === "enter") {
        // Symmetric: 0% the instant the top edge enters the bottom of the
        // viewport, 100% as the bottom edge leaves the top of the viewport.
        // Spreads the scrub across the section's whole travel through the
        // screen, so it eases in on the way in AND out on the way out.

...
class ScrubFlow extends HTMLElement {
  connectedCallback() {
    ...
    const MARGIN = "0px"; // no built-in gap — control spacing per breakpoint in Wix
    ...
    // Height is tied straight to the viewport (100vh) so it stays put on
    // resize instead of drifting.
    this.innerHTML = `
      <div class="ss-bleed" style="position:relative;width:100vw;left:50%;
           transform:translateX(-50%);height:100vh;box-sizing:border-box;
           padding:${MARGIN};">
